...
const RUTAS = {
  ...
  notas:          require('../lib/handlers/notas'),
  'estados-pdf':  require('../lib/handlers/estados-pdf'),
  'costos-pdf':   require('../lib/handlers/costos-pdf'),
  'ingresos-egresos-pdf': require('../lib/handlers/ingresos-egresos-pdf'),
  'cierre-paquete': require('../lib/handlers/cierre-paquete'),
