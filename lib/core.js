...
const SHEETS = {
  ...
  // ===== Producción =====
  // TODO vive en el archivo consolidado. Ahí se captura y ahí el ERP escribe lo que
  // calcula. No se reparte entre dos archivos: eso ya causó que un pedido capturado
  // desde el ERP terminara en un archivo distinto al que se estaba mirando.
  prov_pedidos:  { id: '11kiRhoY0r6EG3Iq0aMwW7m5zYEaltz1nJcHNRmF3moc', sheetName: 'Pedidos a Proveedores' },
  prov_entradas: { id: '11kiRhoY0r6EG3Iq0aMwW7m5zYEaltz1nJcHNRmF3moc', sheetName: 'Entradas' },
  prov_salidas:  { id: '11kiRhoY0r6EG3Iq0aMwW7m5zYEaltz1nJcHNRmF3moc', sheetName: 'Salidas' },
  ...
  prov_pedidos: [
    {
      ...
      type: 'tabla',
      id: '11kiRhoY0r6EG3Iq0aMwW7m5zYEaltz1nJcHNRmF3moc',
