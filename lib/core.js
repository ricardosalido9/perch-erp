...
const SHEETS = {
  ...
  // Egresos: apunta al mismo archivo; confirmar pestaña con /api/erp?action=inspect
  fin_egresos:  { id: '1ex3bs65tKxcDECzn1PnUZf2NRG2qgxkeMyp8IVueGuU', sheetName: 'EGRESOS' },
};
