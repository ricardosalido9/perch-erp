...
const SHEETS = {
  ...
  // ===== Producción =====
  // Pedidos, entradas y salidas se leen del archivo VIVO de Operación, el que ustedes
  // siguen capturando. El consolidado solo guarda Stock, Revisar y las Comparativas.
  ...
  prov_pedidos: [
    {
      ...
      headerRow: 2,
      levels: [
        { field: 'Productos', from: ['Productos', 'Producto'], fromIndex: 1 },
      ...
      fills: [
        { field: 'Costo Unitario', from: ['Costos Total', 'Costo Unitario', 'Costo Total'] }
      ]
    },
    {
...
module.exports = { MENU, SHEETS, USERS_SHEET, FORMULA_FIELDS, AREA_ROW_FILTERS, readRange, appendRow, updateRow,
  getDrive, copiarFormulas, writeCells, escribirTabla, asegurarPestana,
