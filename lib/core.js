...
const MENU = [
  ...
  { key:'facturacion', label:'Facturación', icon:'receipt', children:[
      ...
      { key:'cfdi_control', label:'CFDIs contra complementos' },
      { key:'fac_impuestos',    label:'Impuestos' }
  ] },
  { key:'cfdi_compras', label:'CFDIs de compras', icon:'inbox', children:[
      { key:'cfdi_prov',      label:'Qué me deben los proveedores' },
      { key:'prov_razon',     label:'Nombres y razones sociales' }
  ] },
...
const SHEETS = {
  ...
  rh_personal:   { id: '1F8VTHJiLuBRt4kgAN2gbDxwmenKSouPZESI5x6qwltI', sheetName: 'Nomina' },
  // Nómina corriente: lo que se paga cada semana
  rh_nomina:     { id: '1OE5Pm9eCqlq3CUmt8m8sm0lgL_lTQbBt-PHIKCqoE2M', sheetName: 'Nómina 2026' },
};
