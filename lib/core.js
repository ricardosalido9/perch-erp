...
const PERMISOS = {
  ...
  operativo: {
    menus: ['inicio', 'produccion'],
    areas: ['inicio', 'prov_pedidos', 'prov_entradas', 'prov_salidas', 'op_stock', 'op_revisar',
            'proveedores', 'inv_prov', 'inventario', 'op_envios'],
    ocultarColumnas: []
  },
  // Logística: solo su calendario. No ve precios, ni costos, ni nada de dinero.
  logistica: {
    menus: ['logistica'],
  ...
  logistica: {
    menus: ['logistica'],
    areas: ['log_calendario'],
    ocultarColumnas: ['Precio Unitario', 'Total con envio sin impuestos', 'Total con IVA',
                      'Costo Unitario', 'Costo Total', 'Utilidad', 'Margen', 'Descuentos']
  },
