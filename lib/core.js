...
const SHEETS = {
  ...
  fac_emitidos:  { id: CFG.ARCHIVOS.CFDI_EMITIDOS, sheetName: CFG.PESTANAS.cfdiVigentes },
  // CFDIs emitidos: la verdad del SAT sobre facturas y complementos
  cfdi_vigentes: { id: CFG.ARCHIVOS.CFDI_EMITIDOS, sheetName: CFG.PESTANAS.cfdiVigentes },
  // CFDIs que nos emiten los proveedores. Falta el id del archivo.
  cfdi_recibidos: { id: CFG.ARCHIVOS.CFDI_RECIBIDOS, sheetName: CFG.PESTANAS.cfdiVigentes },
