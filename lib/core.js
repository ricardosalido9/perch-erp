...
const SHEETS = {
  ...
  // ===== Producción =====
  // Pedidos a Proveedores se captura en el CONSOLIDADO (indicación del 11 de agosto).
  // Entradas y Salidas siguen en Operación 2026, donde está la historia completa.
