...
const PERMISOS = {
  ...
  operativo: {
    ...
    areas: ['inicio', 'prov_pedidos', 'prov_entradas', 'prov_salidas', 'op_stock', 'op_revisar',
            ...
            // El registro de ventas, para ver qué se vendió y con qué material.
            // Cotizaciones no: eso es del área comercial.
            'ventas_registro'],
    // Producción ve qué se vendió, no a qué precio. Se esconden las columnas de
    // dinero de la hoja de ventas; el Costo Unitario de los pedidos sí lo ve,
    // porque es lo que necesita para pedirle al proveedor.
    ocultarColumnas: ['Precio Unitario', 'Importe', 'Total con IVA', 'Total sin IVA',
                      'Total con envio sin impuestos', 'Utilidad', '% Utilidad', 'Margen',
                      'Descuentos', '% descuento', 'Anticipo', 'Finiquito']
  },
  ...
  fiscal: {
    ...
    areas: ['inicio',
            'fac_control', 'cfdi_control', 'cfdi_prov', 'prov_razon', 'fac_impuestos', 'fin_banco',
            'fac_emitidos',
