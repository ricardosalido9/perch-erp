...
const SHEETS = {
  ...
  // ===== Producción (archivo consolidado "Operación PERCH") =====
  ...
  // Archivos viejos: se dejan como respaldo, fuera del menú
  ...
  prov_pedidos: [
    {
      ...
      headerRow: 2,
      levels: ['Productos', 'Material'],
      levelsFrom: [
        { from: ['Productos', 'Producto'], fromIndex: 1 },
        { from: ['Material'], fromIndex: 2 }
      ],
      fills: [
