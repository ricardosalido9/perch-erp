  ...
  ventas_registro: [
    {
      ...
      levels: [
        ...
        { field: 'Material',        from: ['Coleccion', 'Colección'] },              // la madera (Nogal, Tzalam…)
        { field: 'Material Extra',  from: ['Material', 'Material Extra'] }           // 2º eje (Tela, Kraft, Acero…)
      ],
      fills: [
        { field: 'Tipo de Producto', from: ['Tipo de Producto', 'Categoria producto', 'Categoría', 'Tipo de Mueble'] },
        { field: 'Precio Unitario',  from: ['Precio Unitario', 'Precio', 'Precio de Venta', 'PVP'] },
        { field: 'Costo Unitario',   from: ['Costo Unitario', 'Costos', 'Costo'] }
      ]
