    ...
    const salida = Object.keys(provs).map(k => {
      ...
      const pedidos = Object.keys(p.pedidos).map(kd => {
        ...
        return Object.assign({}, d, {
          // El saldo NUNCA se toca: la nota explica, no cuadra.
          liquidado: !!(info && info.cerrado), notaAjuste: info ? info.nota : '',
      ...
      const conNota = pedidos.filter(x => x.notaAjuste);
      return {
        ...
        totales: {
          ...
          // El saldo del proveedor es el real: costo menos pagado, sin excepciones
