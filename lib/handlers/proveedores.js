...
module.exports = async (req, res) => {
  try {
    ...
    // Pedidos que ya se dieron por liquidados con un ajuste manual. La fuente es
    // "Mi hoja": si el comentario menciona un ajuste, ese pedido queda saldado
    // aunque el importe y los pagos no coincidan.
    const liquidados = {};
    try {
