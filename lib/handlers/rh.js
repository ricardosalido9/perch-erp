  ...
  try {
    ...
    return res.status(200).json({
      ...
      totales: {
        ...
        costoMensual: suma(activos, 'costo') || suma(activos, 'neto'),
        netoMensual: suma(activos, 'neto'),
