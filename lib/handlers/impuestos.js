  ...
  try {
    ...
    if (emit.headers.length) {
      ...
      if (emitComp.headers.length) {
        const cRel = col(emitComp.headers, 'UUID CFDI Pago', 'UUIDs Facturas relacionadas', 'UUID Documento Relacionado', 'IdDocumento', 'UUIDRel', 'UUID Relacion');
    ...
    if (recib.headers.length) {
      ...
      if (recibComp.headers.length) {
        const cRel = col(recibComp.headers, 'UUID CFDI Pago', 'UUIDs Facturas relacionadas', 'UUID Documento Relacionado', 'IdDocumento', 'UUIDRel', 'UUID Relacion');
