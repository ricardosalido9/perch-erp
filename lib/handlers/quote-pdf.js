  ...
  try {
    ...
    try {
      ...
      return res.status(200).json({
        ...
        aviso: drive.esCuota(msg)
          ? 'La carpeta de Drive está en "Mi unidad" y las cuentas de servicio no tienen cuota. Muévela a una Unidad Compartida.'
          : 'No se pudo guardar en Drive: ' + msg
      });
    }
  } catch (e) {
