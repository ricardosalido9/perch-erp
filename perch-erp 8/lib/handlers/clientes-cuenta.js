...
module.exports = async (req, res) => {
  try {
    ...
    let [ven, ing, cxc] = await Promise.all([
      leer('ventas_registro'), leer('fin_ingresos'), leer('fin_cxc')
    ]);
    // Los cobros viven SOLO en el archivo de finanzas, pestaña INGRESOS.
    const fuentesIngresos = ing.headers.length ? [{ nombre: 'INGRESOS', datos: ing }] : [];
